...
impl Codec for FormUrlencodedCodec {
    ...
    unsafe fn encode(
        ...
        let written = percent_encode_byte(*value, output, output_index, PercentEncodingMode::FormUrlencoded);
    ...
    unsafe fn decode_eof(
        ...
        let (value, consumed) = percent_decode_byte(input, input_index, true).map_err(|error| match error {
